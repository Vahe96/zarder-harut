    ...
    <header className={`fixed top-0 left-0 right-0 z-30 border-b border-border bg-background/90 backdrop-blur-sm transition-all duration-400 ${isScrolled ? "shadow-[0_10px_30px_rgba(0,0,0,0.18)]" : ""}`}>
      <div className="grid grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] items-center gap-2 px-3 py-2.5 sm:gap-4 sm:px-5 xl:grid-cols-[minmax(180px,1fr)_auto_minmax(180px,1fr)] xl:px-12 xl:py-3">
        ...
        <a
          ...
          className="header-brand group col-start-2 flex min-w-0 items-center justify-center overflow-hidden xl:col-start-1 xl:justify-start xl:pl-20"
        ...
        >
          <picture>
            ...
            <img
              ...
              alt="Դրախտը"
              className={`header-brand-image h-11 w-auto max-w-[140px] object-contain opacity-90 transition-all group-hover:opacity-100 sm:h-12 sm:max-w-[170px] xl:h-7 xl:max-w-[210px] ${themeMode === "light" ? "invert" : ""}`}
            />
          </picture>
        </a>

        {/* Desktop nav */}
        <nav className="hidden items-center justify-center gap-8 whitespace-nowrap min-[1440px]:col-start-2 min-[1440px]:flex">
        ...
        <div className="col-start-3 flex items-center justify-end gap-2 sm:gap-4">
          ...
          <a
            ...
            className="hidden text-foreground/65 transition-colors hover:text-foreground min-[1440px]:flex"
            aria-label="Որոնում"
          >
            <Search size={17} />
          </a>
          ...
          <button className="text-foreground/70 transition-colors hover:text-foreground min-[1440px]:hidden" onClick={() => setMobileOpen(!mobileOpen)} aria-label="Մենյու">
      ...
      {/* Mobile menu */}
      <div className={`overflow-hidden border-t border-border transition-all duration-300 min-[1440px]:hidden ${mobileOpen ? "max-h-80" : "max-h-0"}`}>
